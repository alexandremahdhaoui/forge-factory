...
// LogAll provides a mock function for the type MockGit
func (_mock *MockGit) LogAll(ctx context.Context, dir string, path string) ([]string, error) {
	ret := _mock.Called(ctx, dir, path)

	if len(ret) == 0 {
		panic("no return value specified for LogAll")
	}

	var r0 []string
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string) ([]string, error)); ok {
		return returnFunc(ctx, dir, path)
	}
...
// MockGit_LogAll_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'LogAll'
type MockGit_LogAll_Call struct {
	*mock.Call
}

// LogAll is a helper method to define mock.On call
//   - ctx context.Context
//   - dir string
//   - path string
func (_e *MockGit_Expecter) LogAll(ctx any, dir any, path any) *MockGit_LogAll_Call {
	return &MockGit_LogAll_Call{Call: _e.mock.On("LogAll", ctx, dir, path)}
}

func (_c *MockGit_LogAll_Call) Run(run func(ctx context.Context, dir string, path string)) *MockGit_LogAll_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockGit_LogAll_Call) Return(strings []string, err error) *MockGit_LogAll_Call {
	_c.Call.Return(strings, err)
	return _c
}

func (_c *MockGit_LogAll_Call) RunAndReturn(run func(ctx context.Context, dir string, path string) ([]string, error)) *MockGit_LogAll_Call {
	_c.Call.Return(run)
	return _c
}
...
// WorktreePrune provides a mock function for the type MockGit
func (_mock *MockGit) WorktreePrune(ctx context.Context, dir string) error {
	ret := _mock.Called(ctx, dir)
...
// MockGit_WorktreePrune_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'WorktreePrune'
type MockGit_WorktreePrune_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - dir string
func (_e *MockGit_Expecter) WorktreePrune(ctx any, dir any) *MockGit_WorktreePrune_Call {
	return &MockGit_WorktreePrune_Call{Call: _e.mock.On("WorktreePrune", ctx, dir)}
}

func (_c *MockGit_WorktreePrune_Call) Run(run func(ctx context.Context, dir string)) *MockGit_WorktreePrune_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockGit_WorktreePrune_Call) Return(err error) *MockGit_WorktreePrune_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockGit_WorktreePrune_Call) RunAndReturn(run func(ctx context.Context, dir string) error) *MockGit_WorktreePrune_Call {
	_c.Call.Return(run)
	return _c
}
